...
ActiveRecord::Schema.define(version: 2020_08_24_021248) do
  ...
  create_table "transactions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_history_id"], name: "index_transactions_on_purchase_history_id"
  end
  ...
  add_foreign_key "transactions", "purchase_histories"
end
